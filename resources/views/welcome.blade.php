...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
    ...
    <article 
        @class([
            'rounded-3xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl overflow-hidden',
            'md:col-span-2' => $loop->first
        ])
    >
        <!-- Imagen de encabezado -->
        <div class="relative h-40 bg-cover bg-center rounded-t-3xl" 
